        ...
        <svg style={styles.illustration} viewBox="0 0 400 400">
            <defs>
                <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{stopColor: '#AED581', stopOpacity:1}} />
            ...
            <g className="float-1">
                ...
                <path d="M120 120 l20 20 M140 120 l-20 20" stroke="#8BC34A" strokeWidth="4" />
            </g>
             <g className="float-2">
                <circle cx="280" cy="150" r="35" fill="#FFFFFF" style={styles.shape} />
                <path d="M280 135 v30 M265 150 h30" stroke="#4CAF50" strokeWidth="4" />
            </g>
            <g className="float-3">
                <path d="M120 280 l40 -70 l40 70 Z" fill="#FFFFFF" style={styles.shape} />
                <circle cx="160" cy="245" r="8" fill="#AED581" />
            </g>
             <g className="float-4">
                <rect x="250" y="270" width="70" height="70" rx="35" fill="#FFFFFF" style={styles.shape} />
                <circle cx="285" cy="305" r="15" fill="none" stroke="#33691E" strokeWidth="4" />
            </g>
        </svg>
    </div>
);
...
export default function LoginPage() {
    ...
    const styles = {
        pageContainer: { fontFamily: '"Poppins", sans-serif', backgroundColor: '#F1F8E9', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', position: 'relative' },
        ...
        title: { fontSize: '2rem', fontWeight: '700', color: '#1B5E20', marginBottom: '0.5rem' },
        subtitle: { color: '#33691E', marginBottom: '2rem' },
        
        formLabel: { fontWeight: '600', marginBottom: '0.5rem', display: 'block', fontSize: '0.9rem' },
        input: { width: '100%', padding: '0.9rem 1rem', border: '1px solid #C5E1A5', backgroundColor: '#FFFFFF', borderRadius: '8px', fontSize: '1rem', boxSizing: 'border-box', marginBottom: '1.5rem' },
        ...
        forgotPassword: { color: '#4CAF50', textDecoration: 'none' },

        primaryButton: { width: '100%', padding: '0.9rem', backgroundColor: '#4CAF50', color: '#FFFFFF', border: 'none', borderRadius: '8px', fontSize: '1rem', fontWeight: '500', cursor: 'pointer', transition: 'background-color 0.2s ease' },
        googleButton: { width: '100%', padding: '0.9rem', backgroundColor: 'transparent', color: '#1B5E20', border: '1px solid #C5E1A5', borderRadius: '8px', fontSize: '1rem', fontWeight: '500', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', marginTop: '1rem' },
        
        signUpPrompt: { textAlign: 'center', marginTop: '2rem', color: '#33691E' },
        signUpLink: { color: '#4CAF50', fontWeight: 'bold', textDecoration: 'none' },
        
        rightPanel: {
            flex: 1.2,
            background: 'linear-gradient(45deg, #AED581, #DCEDC8)',
            display: 'flex',
            alignItems: 'center',
    ...
    const keyframes = `
        ...
        .float-1 { animation: hero-float-1 10s ease-in-out infinite; }
        .float-2 { animation: hero-float-2 12s ease-in-out infinite; }
        .float-3 { animation: hero-float-3 14s ease-in-out infinite; }
        .float-4 { animation: hero-float-4 8s ease-in-out infinite; }
        .primary-button:hover { background-color: #388E3C; }
        .google-button:hover { background-color: #E8F5E9; }
    `;
                ...
                <div style={styles.loginCard}>
                    <div style={styles.leftPanel}>
                        ...
                        <form>
                            ...
                            <input type="email" style={{...styles.input, marginBottom: '1.5rem'}} />

                            <label style={styles.formLabel}>Password</label>
                            <div style={styles.passwordInputContainer}>
                               <input type={showPassword ? 'text' : 'password'} style={{...styles.input, marginBottom: 0}} />
                            ...
                            <button type="submit" style={styles.primaryButton} className="primary-button">Sign in</button>
                            <button type="button" style={styles.googleButton} className="google-button"><GoogleIcon /> Sign in with Google</button>
                        </form>
